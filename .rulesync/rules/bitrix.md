...
root: true
targets: ["*"]
description: "Правила разработки 1С-Битрикс с AI-агентом (генерируется из core/AGENTS.md)"
globs: ["**/*.php"]
---

<!-- ГЕНЕРИРУЕТСЯ из core/AGENTS.md командой build.sh. Правь ИСТОЧНИК, не этот файл. -->
